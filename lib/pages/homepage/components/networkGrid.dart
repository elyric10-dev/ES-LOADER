...
// GCASH MODAL PANEL
  Future<dynamic>
      modalBottom(BuildContext context, Map<String, dynamic> item) =>
          showModalBottomSheet(
            ...
            builder: (BuildContext context) {
              ...
              int? insertedCoin;
              int? fee;
              // int? total = (fee ?? 0) + int.parse(amount);
              // print("Total: $total");
              bool filledUpInput() {
                                        ...
                                        ? _isReview
                                            ? Column(
                                                children: [
                                                  ...
                                                  Text(
                                                    "Service fee: P${serviceFee(int.parse(amount))}.00",
                                                    style: const TextStyle(
                                                      fontSize: 23,
                                                    ),
                                                  )
                                                ...
                                                ? _isLoading
                                                    ...
                                                    : CustomButton(
                                                        ...
                                                        onPressed: () async {
                                                          ...
                                                          String?
                                                              errorResponse =
                                                              "Currently do not have enough balance for this amount 🥲.";
                                                          String?
                                                              detectErrorResponse =
...
final String tableName = 'inventories1';

Future<Database> openDB() async {
  var databasesPath = await getDatabasesPath();
  String path = join(databasesPath, 'server.db');
    ...
    onCreate: (Database db, int version) async {
      await db.execute('''
        CREATE TABLE $tableName (
          ...
          timestamp TEXT,
          transaction_id TEXT,
          has_enquired INTEGER,
          enquire_fixed INTEGER
        )
      ''');
    },
  );
